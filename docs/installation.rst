...
The sources for Oop_ext can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/ESSS/oop-ext
.. _tarball: https://github.com/ESSS/oop-ext/tarball/master
